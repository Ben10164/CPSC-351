...
Regular Languages has regular expressions, and they have these machines that tell us if it is part of the languaeg (finite state machine)
...
* Chompsky normal Form
  * A context free gramar is in chompsky normal form if every rule is of the form:
    * $A \rarr BC$
